...
> [`engine-usage.md`](engine-usage.md) (synced from strix) is the
> *engine team's* wrapper-integration guide written *by* the strix team
> *for* wrapper authors; this one is for users / buyers of the deployed
> product.
>
...
| [`engine-usage.md`](engine-usage.md) | Engine team's wrapper-integration guide (what the engine emits) |
